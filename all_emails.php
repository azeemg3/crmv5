...
<body onLoad="call_ajax('marketing/ajax_call/get_all_emails', 'form', 'get_all_emails')">
...
<div class="content-wrapper">
  ...
  <h2 style="text-align:center;display:block;margin:0px;padding:10px 0px;background:#cdcccc;"><span class="main-heading">All Emails</span></h2>
      ...
      <form id="form">
        ...
        <div class="col-lg-2">
          <div class="form-group">
            ...
            onClick="call_ajax('marketing/ajax_call/get_all_emails', 'form', 'get_all_emails')"><i class="fa fa-search"></i> search</button>
