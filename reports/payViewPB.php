...
?>
<script>
document.title='Petty Book Reports';
</script>
    ...
    <div class="modal-dialog" style="width:70%;">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h2 class="modal-title" align="center">Petty  Book-><span id="db_dt"></span> </h2>
          <p>
          	<div class="col-lg-3">
            	Branch: <span id="branchName"></span>
            </div>
            <div class="col-lg-6 pull-right">
            	<button type="button" class="btn btn-default btn-sm" id="p_id" value="" onClick="()">
...
<section class="content-header" style="border-bottom:1px solid;padding-bottom: 14px;">
	...
	<h2 style="text-align:center;display:block;margin:0px;padding:10px 0px;font-style:italic;background:#cdcccc;"><span class="main-heading">Petty Book Reports</span></h2>
