...
<body onLoad="call_ajax('ajax_call/get_agentLeads', 'form', 'get_agentLeads')">
<?php $cm->loader(); ?>
                ...
                <div class="box-body">
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">Agent Leads</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="table-responsive">
                            <form id="form">
                                ...
                                <div class="col-lg-2 col-sm-3">
                                    <div class="form-group">
                                        <select class="select2 form-control input-sm" name="spo">
                                            <option value="">Select Reopen By</option>
                                            <?php echo $cm->Currentspo('', $_SESSION['branch_id']) ?>
                                        </select>
                                    </div>
                                </div>
                                <!-- col-lg-2-->
                                ...
                                <div class="col-lg-2 col-sm-3">
                                    <div class="form-group">
                                        <select class="form-control input-sm" name="lp">
                                ...
                                <div class="col-lg-2 col-sm-3">
                                    <div class="form-group">
                                        <button type="button" class="btn btn-primary btn-sm" onClick="call_ajax('ajax_call/get_agentLeads', 'form', 'get_agentLeads')"><i class="fa fa-search"></i>Search</button>
