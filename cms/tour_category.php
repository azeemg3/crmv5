...
$cm->get_header("../");
?>
<body onLoad="call_ajax('ajax_call/get_tour_category', '', 'get_tour_category')">
<div class="content-wrapper">
  ...
  <section class="content">
    <h2 style="text-align:center;display:block;margin:0px;padding:10px 0px;background:#cdcccc;"><span class="main-heading">
     Tour Categories</span> </h2>
    <div class="panel panel-default panel-default-top-radius">
      <div class="panel-body">
      	<div class="col-md-2 pull-right row">
         <a href="addNew-tour-category" class="btn btn-primary btn-flat pull-right">Add New</a>
        </div>
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-striped">
            ...
            <tbody class="get_tour_category"></tbody>
          </table>
        </div>
      </div>
      <!--panel panel-default--> 
