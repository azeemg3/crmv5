...
$cm->get_header("../");
?>
<body onLoad="call_ajax('ajax_call/get_tour_pkg', '', 'get_tour_pkg')">
  ...
  <section class="content">
    ...
    <div class="panel panel-default panel-default-top-radius">
      <div class="panel-body">
         ...
         <a href="addNew-tour-packages" class="btn btn-primary btn-flat pull-right">Add New</a>
        </div>
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-striped">
            ...
            <tbody class="get_tour_pkg"></tbody>
          </table>
        </div>
      </div>
      <!--panel panel-default--> 
