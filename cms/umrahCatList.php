...
$cm->get_header("../");
?>
<body onLoad="call_ajax('ajax_call/get_umrahCatList', '', 'get_umrahCatList')">
      ...
      <div class="panel-body">
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-striped">
            ...
            <tbody class="get_umrahCatList"></tbody>
          </table>
        </div>
      </div>
      <!--panel panel-default--> 
