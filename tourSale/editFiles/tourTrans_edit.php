<div class="modal fade" id="edit_tour_trans" role="dialog">
    <div class="modal-dialog">
      ...
      <input type="hidden" name="id" id="tTransId" />
            ...
            <div class="col-lg-6">
            	<div class="form-group">
                	<label>Qty</label>
                    <input type="text" name="transQty" class="form-control input-sm transQty" onchange="tTransportCal('edit_tourTransport')">
                </div>
            </div>
            <!--col-lg-2-->
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
            	<div class="form-group">
                    ...
                    <input list="transSupp" name="transSupp" value="" class="form-control input-sm">
                    <datalist id="transSupp">
            ...
            <!--col-lg-2-->
             <div class="col-lg-6">
            	<div class="form-group">
                    ...
                    <input name="transPp" type="text" class="form-control input-sm transPp" onchange="tTransportCal('edit_tourTransport')" value="" />
                </div>
            </div>
            <!--col-lg-2-->
            <div class="col-lg-6">
            	<div class="form-group">
                    ...
                    <input name="transSp" type="text" class="form-control input-sm transSp" onchange="tTransportCal('edit_tourTransport')" value="" />
                </div>
            </div>
            <!--col-lg-2-->
            <div class="col-lg-6">
            ...
            <!--col-lg-12-->                
               <div class="col-lg-12">
                ...
                <label>&nbsp;</label>
                    ...
                    onclick="tour_add('edit_tourTransport', 'tourTrans', 'tourSale/ajax_call/getTour', 'tourTransId')">
                </div>
            </div>
            <!--col-lg-12-->          
                </div>
