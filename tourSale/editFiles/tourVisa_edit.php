<div class="modal fade" id="edit_tour_visa" role="dialog">
      ...
      <input type="hidden" name="id" id="tVisaId" />
            ...
            <div class="col-lg-6">
            	<div class="form-group">
                    ...
                    onchange="visaTCal('edit_tour_visa')">
                </div>
            </div>
            <!--col-lg-2-->
            ...
            <div class="col-lg-6">
            	<div class="form-group">
                    ...
                    <input type="text" name="visaPp" id="eVisaPp" value="" class="form-control input-sm visaPp" onchange="visaTCal('edit_tour_visa')">
                </div>
            </div>
            <!--col-lg-2-->
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
            	<div class="form-group">
                    ...
                    <input type="text" name="t_visaSp" value="" id="" class="form-control input-sm tVisaSp" readonly />
                </div>
            </div>
            <!--col-lg-2-->
             <div class="col-lg-12">
            ...
            <div col-lg-12>
                ...
                <label>&nbsp;</label>
                    ...
                    onclick="tour_add('e_tour_visa','tourVisa', 'tourSale/ajax_call/getTour', 'tourVisaId')">
                </div>
            </div>          
                </div>
                <!-- col-lg-12-->
