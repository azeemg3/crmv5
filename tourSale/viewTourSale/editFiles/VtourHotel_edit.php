<div class="modal fade" id="Vedit_tour_hotel" role="dialog">
      ...
      <input type="hidden" name="id" id="tHotelId" />
            ...
            <div class="col-lg-6">
            	<div class="form-group">
                    ...
                    onchange="cnightTourhotel('Vedit_tourHotel')">
                </div>
            </div>
            <!--col-lg-2-->
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
            	<div class="form-group">
                    ...
                    <input type="text" name="hotelCheckout" id="" value="" class="form-control input-sm date hotelCheckout" onchange="cnightTourhotel('Vedit_tourHotel')">
                </div>
            </div>
            <!--col-lg-2-->
             <div class="col-lg-6">
            ...
            <!--col-lg-2-->
             <div class="col-lg-6">
            	<div class="form-group">
                    ...
                    onchange="hTsCal('Vedit_tourHotel')">
                </div>
            </div>
            <!--col-lg-2-->
            <div class="col-lg-6">
            	<div class="form-group">
                    ...
                    <input type="text" name="hotelSp" value="" id="ehotelSp" class="form-control input-sm hotelSp" onchange="hTsCal('Vedit_tourHotel')">
                </div>
            </div>
            <!--col-lg-2-->
            <div class="col-lg-6">
            ...
            <div class="col-lg-12">
                ...
                <label>&nbsp;</label>
                    ...
                    onclick="update_tour('Vedit_tourHotel', 'tourHotel', 'VtourHotelId', 'tourSale/ajax_call/view_getTour', 'Vedit_tour_hotel')">
                </div>
            </div>
            <!--col-lg-12-->          
                </div>
