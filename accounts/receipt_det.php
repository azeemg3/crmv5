...
<div class="content-wrapper" id="loadpage">
	...
	<div class="panel panel-default col-lg-6" style="border-radius:0px; border:0px;">
        ...
        <div class="col-md-3">
         <div class="form-group">
          <label><?php if(!empty($ref_id)) { echo 'TP-PV';} else echo 'TP-RV';?></label>
        ...
        <div class="clearfix"></div>
          <div class="table-responsive">
          	<table class="table table-bordered table-striped">
            	<tr>
                	<td><?php if(!empty($ref_id)) echo 'Refund'; else echo 'Receipt'; ?> No:</td>
