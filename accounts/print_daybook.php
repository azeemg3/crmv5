...
session_start();
$obRow="";
	$ob_result=$cm->selectData("trans_acc","(trans_acc_type='Bank' OR trans_acc_type='Cash') 
	...
	while($ob_row=$ob_result->fetch_assoc())
	{
		...
		$obRow.='
				<tr>
					<td colspan="4" align="right">'.$ob_row['trans_acc_name'].'&nbsp;&nbsp;</td>
...
<div id="header">
        ...
        <hr />
        <div id="exchange">Cash/Bank Book (All A/C) From <?php echo $dt_frm.' To '.$dt_to ?></div>
